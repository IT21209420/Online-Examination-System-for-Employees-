...
if(isset($_POST['submit'])) {
   $admin_name=$_POST['Name'];
    ...
    $sql="update `administrator` set admin_ID=$admin_ID, admin_name='$admin_name',admin_type='$admin_type',admin_email='$admin_email' where admin_ID=$admin_ID";
    $result=mysqli_query($con,$sql);
    if($result){
...
<p><h1>Update Admin</h1></p>

    <div class="content">
            <form method= "post">
  <div class="form-group"> 
    <label style="color:Black" >Admin Name</label>
    <input type="text" class="form-control"  placeholder="Enter Admin Name" name="Name" autocomplete="off" value=<?php  
    echo $admin_name;?>>
</div>
<div class="form-group">
    <label style="color:Black" >Admin Type</label>
    <input type="text" class="form-control"  placeholder="Enter Admin Type" name="Type" autocomplete="off" value=<?php  
    echo $admin_type;?>>
</div>
<div class="form-group">
    <label style="color:Black">Admin Email</label>
    <input type="text" class="form-control"  placeholder="Enter Admin Email" name="email" autocomplete="off" value=<?php  
    echo $admin_email;?>>
</div>
