...
<body>
  ...
  <div class="container-login-big">
 <div class="container-login">
     <div class="login-box1">
         <button class="usrbtn"><a href=userLogin.php>Candidate login</a></button>
     </div>
    <div class="login-box2">
        <button class="supbtn"><a href=supervisorLogin.php>Supervisor login</a></button>
    </div>
    <div class="login-box3">
        <button class="adbtn"><a href=adminLogin.php>Admin login</a></button>
    </div>
</div>
