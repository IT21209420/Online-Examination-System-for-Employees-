...
<html>
    ...
    <head>
      ...
      <style>
        body {
          ...
          .btn-exams button {
              background-color: #008cfe; /* Green background */
              border: 1px solid rgb(51, 0, 255); /* Green border */
              ...
              .btn-exams button:not(:last-child) {
              border-bottom: none; /* Prevent double borders */
              }

              /* Add a background color on hover */
              .btn-exams button:hover {
              background-color: #3692cb;
              }

              .btn-dep button:hover {
              background-color: #3692cb;
              }
              ...
              .btn-dep button {
              background-color: #0580f3; /* Green background */
              border: 1px solid rgb(6, 201, 250); /* Green border */
              color: white; /* White text */
              padding: 20px 20px 24px 30px; /* Some padding */
              cursor: pointer; /* Pointer/hand icon */
              width: 50%; /* Set a width if needed */
              display: block; /* Make the buttons appear below each other */
              }
    ...
    <body>
        ...
        <div class="header"> 
            ...
            <div class="containerh2">
                ...
                <form class="example" action="action_page.php">
                    <input type="text" class="sea" placeholder="Search Courses" name="search">
        ...
        <div class="container2">
          ...
          <div class="container">
      <div class="btn-exams">
          <button class="btn"><a href=registerExam.html>Register for exams</button>
        </div>
        <div class="btn-exams">
          <button class="btn"><a href=Search.html>Search for courses</button>
        </div>
          <div class="btn-exams"> 
            <button class="btn"><a href=createxam.html>Create exams</a></button>
          </div>
          <div class="btn-exams"> 
            <button class="btn"><a href=userResults.php>Check exam results</a></button>
          </div>
      ...
      <center>
          ...
          <div class="title"><h2>Departments categories</h2></div> 
      ...
      <div class="btn-dep">
          ...
          <button class="btn">Financial Department</button>
        </div>

        <div class="btn-dep">

          
          <button class="btn">Management Department</button>
        </div>

        <div class="btn-dep">

          
          <button class="btn">Information Technology Department</button>
        </div>

        <div class="btn-dep">

          
          <button class="btn">New Employees</button>
        </div>
      </center>
      </div>
  </div>
